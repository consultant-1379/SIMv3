...
# Start execution
$JAVA -Duser.dir=$APP_HOME -Dapp.home=$APP_HOME -Dlog4j.configurationFile=file:$ETCDIR/log4j2.xml -Dconfig=$CONFIG_DEF -cp "$LIBDIR/*:$EXTLIBDIR/*:$POLICYDIR/*:$PROTOCOLDIR/*" com.ericsson.sim.cli.Main "$@"
